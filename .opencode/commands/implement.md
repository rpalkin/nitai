---
description: Find a planned task, execute implementation plan in git worktree, mark for review
---
...
!`task update $1 --status in_progress --assigned-to implementation-agent`
...
- `task log $1 --section changes "what you modified (file:line — description)"`
...
!`task update $1 --status in_review`

Then show the user a summary: "Task `$1` is now marked **in review**. Worktree is at `../$1`." Include a brief summary of what was changed.
